    ...
    className="section bg-primary">
        <div className="container mx-auto">
            ...
            items-center text-center">
                ...
                I'm actively looking for full-time opportunities in web development and am open to work. 
                If you find my profile interesting, please feel free to reach out.
                </p>
            </div>
                ...
                lg:mb-0 lg:pt-2">
                    {
                        contact.map((el, index)=>{
                            const {icon, icon1, icon2, title, 
                                subtitle, description, 
                                remote, phone, github, linkedin} = el;

                            return <div className="flex flex-col lg:flex-row
                            gap-x-4">
                                <div className="text-accent
                                rounded-sm w-14 h-14 flex items-center lg:items-start
                                ...
                                <div>
                                    ...
                                    text-accent p-2 text-lg items-start">
                                        ...
                                        target="_blank">{icon1}</a>
                                        <a href={github} rel="noreferrer"
                                        target="_blank">{icon2}</a>
                                    </div>
                                </div>
                            </div>
                        })
